# GEE(Google Earth Engine)_Record

## 1. Just record

### 1.1 Description

- This is my personal GEE script repository, which contains all of my GEE code throughout my college career. From the first time I came into contact with and learned about GEE to the end of my graduation, I **appreciated** GEE as a platform.
...
- All the JS files were manually copied from the GEE platform to my local machine. Thanks to everyone who helped me during my learning process.

### 1.3 Time

- The first time to learn GEE: **2023_summer(sophomore)**
- **Thats All, THANKS!~**
