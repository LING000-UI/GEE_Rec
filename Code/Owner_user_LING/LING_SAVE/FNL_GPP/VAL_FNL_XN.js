...
var table = ee.FeatureCollection("projects/ee-glj320104/assets/GPP_ROI/xn");
...
var xn_5 = mix_collection2.filter(ee.Filter.eq('month',5))
                          .first();

Export.image.toDrive({
  image:xn_5.select('NDVI'), //分类结果
