...
var table = ee.FeatureCollection("users/LING/GPP_ROI_NAME/SuZhou");
...
var sz_5 = mix_collection2.filter(ee.Filter.eq('month',5))
                          .first();

Export.image.toDrive({
  image:sz_5.select('NDVI'), //分类结果
