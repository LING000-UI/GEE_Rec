...
var table = ee.FeatureCollection("projects/ee-glj320104/assets/CITY/TaiWan");
...
var tw_5 = mix_collection2.filter(ee.Filter.eq('month',5))
                          .first();

Export.image.toDrive({
  image:tw_5.select('NDVI'), //分类结果
