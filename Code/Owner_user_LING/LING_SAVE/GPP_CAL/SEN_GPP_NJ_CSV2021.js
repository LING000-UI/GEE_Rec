...
var ndvi5 = max_collection.filter(ee.Filter.eq('month',5)).first().select('NDVI');
...
Map.addLayer(ndvi5.clip(areaOfInterest),{bands:'NDVI',palette:pal},'img5_of_ndvi');
