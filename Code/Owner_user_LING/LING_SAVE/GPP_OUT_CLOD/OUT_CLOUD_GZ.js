...
Export.image.toDrive({
image:urbrest, //分类结果
description:'type_of_urb_gz', //文件名
scale:10, //分辨率
region:areaOfInterest, //区域
maxPixels:1e13 //此处值设置大一些，防止溢出
});
...
Export.table.toDrive({
  ...
  description: 'dictionary_all_csv_gz',
  fileFormat: 'CSV'
});